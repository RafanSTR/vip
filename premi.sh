...
echo -e "  Auther : ${green}xx ${NC}${YELLOW}(${NC} ${green} xx ${NC}${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/RafanSTR/vip/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/RafanSTR/vip/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/RafanSTR/vip/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "     \e[1;32m2)\e[0m Gunakan Domain Dari Script "
echo -e "   ------------------------------------"
...
wget raw.githubusercontent.com/RafanSTR/vip/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
